...
![](https://i.imgur.com/k4DMoLP.gif)

GIF created with QuickTime.

## Notes

Linking between the storyboard and Swift was a bit confusing initially, particularly when I had to delete a link and then add a new one.
